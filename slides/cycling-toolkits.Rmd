...
```{r, echo=FALSE, out.width="80%"}
knitr::include_graphics("https://github.com/npct/pct-team/figures/front-page-leeds-pct-demo.png")
```
...
knitr::include_graphics("https://github.com/npct/pct-team/figures/pct-frontpage.png")
```
